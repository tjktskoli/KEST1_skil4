...
`git clone --bare git@github.com:tjktskoli/KEST_skil4`

```git clone --bare https://github.com/tjktskoli/KEST_skil4.git```

2.  Búðu til tóma lokaða geymslu (*e. private repo*) á github svæðinu þínu. Skýrðu geymsluna **git_verkefni**.

3. Farðu inn í möppuna **KEST_skil4** á tölvunni þinni og sendu (*e. push*) hana upp á github, í geymsluna sem þú bjóst til í lið 2.
